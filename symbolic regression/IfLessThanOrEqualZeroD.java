/*
 *
 * If Less Than 0 of Equal Then ... Else for doubleClass.
 *
 * if a <= 0 then 
 *   b
 * else 
 ...
 * 
 */
public class IfLessThanOrEqualZeroD
    extends CommandGene implements ICloneable {

  private Class m_type;

  public IfLessThanOrEqualZeroD(final GPConfiguration a_conf, Class a_type)
      throws InvalidConfigurationException {
      this(a_conf, a_type, 0, null);
  }

  public IfLessThanOrEqualZeroD(final GPConfiguration a_conf, Class a_type, int a_subReturnType,
                int[] a_subChildTypes)
      throws InvalidConfigurationException {
  ...
  public Object clone() {
    try {
      IfLessThanOrEqualZeroD result = new IfLessThanOrEqualZeroD(getGPConfiguration(), m_type,
  ...
  public boolean equals(Object a_other) {
    if (a_other == null || ! (a_other instanceof IfLessThanOrEqualZeroD)) {
      return false;
    }
    if (!super.equals(a_other)) {
      return false;
    }
    IfLessThanOrEqualZeroD other = (IfLessThanOrEqualZeroD) a_other;
