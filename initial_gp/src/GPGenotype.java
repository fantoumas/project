...
public class GPGenotype
    ...
    private static IGPProgram m_fittestToAdd;
...
//  }
    ...
    public static Map<String, CommandGene> verifyChildNodes(
            GPConfiguration a_conf, Class[] a_types, CommandGene[][] a_nodeSets) throws InvalidConfigurationException {
        ...
        for (int i = 0; i < a_nodeSets.length; i++) {
            ...
            for (int j = 0; j < a_nodeSets[i].length; j++) {
                ...
                try {
                    node = new CommandGene(a_conf,a_nodeSets[i].length, a_types[0] ) {
                        @Override
