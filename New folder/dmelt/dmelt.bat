...
REM increase Java memory if needed.
...
ECHO Start DataMelt IDE ..
REM java -mx%MAX_JAVA_MEMORY%m -classpath %CLASSPATH% %OPTJJ% %OPTJJJ% %OPTJJJ2% -Djehep.home=%JEHEP_HOME% jehep.ui.mainGUI %CMD_LINE_ARGS%
java -classpath %CLASSPATH% %OPTJJ% %OPTJJJ% %OPTJJJ2% -Djehep.home=%JEHEP_HOME% jehep.ui.mainGUI %CMD_LINE_ARGS%
