from pyann.mlp.neuron   import SigmoidOutputNeuron
from pyann.mlp.layer    import Layer, OutputLayer
...
class SigmoidOutputLayer(OutputLayer):
    ...
    def __init__(self, units, minValue = 0.0, maxValue = 1.0):
        ...
        """
        Layer.__init__(self, [SigmoidOutputNeuron(minValue = minValue, maxValue = maxValue) for i in range(units)])
