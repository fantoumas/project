...
migration   = MigrationCopy(['localhost:1778'], probability = 0.1, individuals = 2)
...
env = Environment(  population, 
                    ...
                    operators = (mpcross, eliteKeep, oldKeep, migration), 
                    postModifiers = (mutate, sortPopulation, truncate, restoreBest) )



continent = Continent('south', env, port = 1777, host = 'localhost')
